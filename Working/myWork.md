...
+ 晚上 帮忙修改签名模块 and 软键盘重新修改 （自己修改被废弃）
...
公证办理 (transact-justly)
完成接口参数对接 
调整界面 将台湾公证书核验与公证办理分离（分开两个路由，但文件未分离）
...
选点实验  城市版 农村版  （根据不同场景配置场景优先）

交互体验

去年 事项  今年 质量 精益求精 

改善不同用户的不同体验（压力测试后续再进行）

## 2/14

## 1/15
修改身份证丢失换领、损坏换领 base64传参错误
...
## 1/21
公证办理高拍仪拍照上传组件 修改拍完后还有加号的问题  下一步后返回上一步还有加号问题
